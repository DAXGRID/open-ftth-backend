...
namespace ConduitNetwork.Events
{
    ...
    /// As you can imagine, many of these events are needed to represent a fiber cable that is blow through several different conduits.
    /// </summary>
    public class ForeignLineEquipmentPlacedWithinConduit
    {
        ...
        /// <summary>
        /// The id of the foreign line to be related to the conduit. It will typical be a fiber cable, but in the future it could be other types such as twister pair network cables etc.
        /// </summary>
        public Guid ForeignLineId { get; set; }

        /// <summary>
        /// At which node (must be within the conduits walk of interest) that the line starts to be inside the conduit.
        /// </summary>
        public Guid FromRouteNodeId { get; set; }

        /// <summary>
        /// At which node (must be within the conduits walk of interest) that the line ends being inside the conduit.
        /// </summary>
